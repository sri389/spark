...
object Home extends Serializable {
  ...
  def main(args: Array[String]): Unit = {
    ...
    //sc.parallelize(Seq(model), 1).saveAsObjectFile("file:////home/hduser/Projects/spark-ml/LRModels/homePricing-model_1")
    //sc.parallelize(Seq(scaler), 1).saveAsObjectFile("file:///home/hduser/Projects/spark-ml/LRModels/homePricingScaler-model_1")
